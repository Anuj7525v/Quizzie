...
import formatDate from "../../Component/Converter/Date";
import toast from "react-hot-toast";
import { useSelector } from "react-redux"; 
import { Link} from "react-router-dom";
import { DeleteQuizModal } from "../../Component/DeleteQuizModal/DeleteQuizModal";
import { EditQA } from "../../Component/QA/QAEdit/QAEdit";
import { EditPoll } from "../../Component/PollChange/PollChange";
...
const MyFunction = ({ analytic, i }) => {
  ...
  return (
    <tr key={analytic._id}>
      ...
      <td>
        <Link to={`/dashboard/analytics/questionWise/${analytic._id}`}
